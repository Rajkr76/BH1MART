    ...
    <>
      ...
      {showButton && !showIOSGuide && (
        <button
          ...
          className="fixed top-20 right-4 z-50 animate-slide-down rounded-xl border-3 border-amber-900 bg-gradient-to-r from-orange-500 to-amber-500 px-4 py-2 text-sm font-black uppercase tracking-wide text-white shadow-[4px_4px_0px_#78350f] hover:shadow-[2px_2px_0px_#78350f] hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex items-center gap-2"
        >
